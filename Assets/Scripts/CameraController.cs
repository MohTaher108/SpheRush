...
{
    // Boolean that will prevent camera movement if the esc key is pressed
    ...
    void Update()
    {
        ...
        // If the esc key is pushed, swap the movement setting
        if(Input.GetKeyDown(KeyCode.Escape))
            doMovement = !doMovement;

        // If movement is turned off, end the function
        if(!doMovement)
            return;
        ...
        // Clamp all positional axes values to keep the camera centered
